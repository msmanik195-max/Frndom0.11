...
data class PageItem(
    ...
    val email: String = "",
    val phone: String = "",
    val dailyPostLimitText: Int = -1,
    val dailyPostLimitImage: Int = -1,
    val dailyPostLimitVideo: Int = -1,
    val dailyPostLimitStory: Int = -1,
    ...
    fun toMap(): Map<String, Any?> = mapOf(
        ...
        "email" to email,
        "phone" to phone,
        "dailyPostLimitText" to dailyPostLimitText,
        "dailyPostLimitImage" to dailyPostLimitImage,
        "dailyPostLimitVideo" to dailyPostLimitVideo,
        "dailyPostLimitStory" to dailyPostLimitStory,

        ...
        try {
            if (FirebaseApp.getApps(this).isEmpty()) {
                ...
                if (FirebaseApp.getApps(this).isEmpty()) {
                    ...
                    val defaultAppId = if (currentPackage == "com.Flikata.admin") {
                        "1:811952393925:android:b2e2df658e1f9f34702aac"
                    } else {
                        "1:811952393925:android:4755f7334040c07c702aac"
                    }
                    val appId = BuildConfig.FIREBASE_APP_ID.takeIf { it.isNotBlank() && it != "dummy" } ?: defaultAppId
                    ...
                    Log.d("FrndomApplication", "Firebase successfully initialized for package $currentPackage with App ID $appId")
                }
            }
        } catch (e: Throwable) {
